...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('danger', 'Data Berhasil DiHapus (Silahkan Cek Trashed Post)');
    }
    ...
    public function kill($id){
        ...
        return redirect()->back()->with('danger', 'Data Berhasil Post Berhasil DiHapus Secara Permanen');
    }
}
